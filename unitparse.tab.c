...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_UNIT_SHIFT = 4,                 /* UNIT_SHIFT  */
  YYSYMBOL_EXPONENT = 5,                   /* EXPONENT  */
  YYSYMBOL_SUPER_SIGN = 6,                 /* SUPER_SIGN  */
  YYSYMBOL_SUPER = 7,                      /* SUPER  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "DOUBLE", "UNIT_SHIFT",
  "EXPONENT", "SUPER_SIGN", "SUPER", "FUNCTION", "ERR", "'+'", "'-'",
  "'/'", "'*'", "UMINUS", "'('", "')'", "'|'", "$accept", "input", "expr",
  "simple_expr", "number", "exponent", "super", YY_NULLPTR
};
...
{
       6,   -12,   -18,    -7,    96,    96,     6,     6,    11,    51,
     -18,   -18,     9,     6,   -18,   -18,    77,    23,   -18,   -18,
       8,     8,     6,     6,     6,     6,    90,   -18,   -18,   -18,
      37,   -18,   -18,   -18,    64,   -18,    64,   -18,    77,    90,
     -18
};
...
{
       0,    17,    14,     0,     0,     0,     0,     0,     0,     2,
       3,    13,     0,     0,     4,     5,    12,     0,     1,    19,
       0,    22,     0,     0,     0,     0,     9,     6,    21,    18,
       0,    16,    20,    23,     7,     3,     8,     3,    11,    10,
      15
};
...
{
       9,    14,    15,    32,    33,    12,    16,    17,    13,     1,
       2,    18,    29,    30,     3,    21,     4,     5,     6,    35,
      37,     7,    34,    36,    38,    39,     1,     2,    19,    20,
      21,     3,     0,    22,    23,    24,    25,     0,     7,    31,
       1,     2,    19,    20,    21,     3,     0,    22,    23,    24,
      25,     0,     7,    40,     1,     2,    19,    20,    21,     3,
       0,    22,    23,    24,    25,     0,     7,     1,     2,    19,
      20,    21,     3,     0,     0,     0,    24,    25,     0,     7,
       1,     2,    19,    20,    21,     3,     0,     0,     0,     0,
      25,     0,     7,     1,     2,    19,    20,    21,     3,     1,
       2,     0,     0,     0,     3,     7,     0,     0,     0,     0,
       0,     7
};
...
{
       0,     4,     5,    20,    21,    17,     6,     7,    15,     3,
       4,     0,     3,    13,     8,     7,    10,    11,    12,    22,
      23,    15,    22,    23,    24,    25,     3,     4,     5,     6,
       7,     8,    -1,    10,    11,    12,    13,    -1,    15,    16,
       3,     4,     5,     6,     7,     8,    -1,    10,    11,    12,
      13,    -1,    15,    16,     3,     4,     5,     6,     7,     8,
      -1,    10,    11,    12,    13,    -1,    15,     3,     4,     5,
       6,     7,     8,    -1,    -1,    -1,    12,    13,    -1,    15,
       3,     4,     5,     6,     7,     8,    -1,    -1,    -1,    -1,
      13,    -1,    15,     3,     4,     5,     6,     7,     8,     3,
       4,    -1,    -1,    -1,     8,    15,    -1,    -1,    -1,    -1,
      -1,    15
};
...
{
       0,     3,     4,     8,    10,    11,    12,    15,    19,    20,
      21,    22,    17,    15,    21,    21,    20,    20,     0,     5,
       6,     7,    10,    11,    12,    13,    20,    23,    24,     3,
      20,    16,    24,    24,    20,    21,    20,    21,    20,    20,
      16
};
...
#define yyclearin       (yychar = YYUNITEMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use YYUNITerror or YYUNITUNDEF. */
#define YYERRCODE YYUNITUNDEF
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = YYUNITEMPTY; /* Cause a token to be read.  */
...
#line 50 "unitparse.y"
       {
	*unit_parse_result = (yyvsp[0].expr);
  }
#line 1405 "unitparse.tab.c"
    break;

  case 4: /* expr: '+' simple_expr  */
#line 59 "unitparse.y"
                               {
...
#line 68 "unitparse.y"
	...
	if ((yyvsp[0].exponent) != 1) {
		(yyval.expr).unit.value = pow((yyvsp[-1].expr).unit.value, (yyvsp[0].exponent));
		for (i = 0; i < N_UNITS; i++)
			(yyval.expr).unit.units[i] = (yyvsp[-1].expr).unit.units[i] * (yyvsp[0].exponent);
	} else {
...
#line 115 "unitparse.y"
	...
	switch ((yyvsp[-3].FUNCTION)) {
		case FUNCTION_SQRT:
			unit_sqrt_internal(&(yyvsp[-1].expr).unit, &(yyval.simple_expr).unit);
			break;
		case FUNCTION_EXP:
			unit_exp_internal(&(yyvsp[-1].expr).unit, &(yyval.simple_expr).unit);
			break;
		case FUNCTION_LN:
			unit_ln_internal(&(yyvsp[-1].expr).unit, &(yyval.simple_expr).unit);
			break;
		case FUNCTION_LOG2:
			unit_log2_internal(&(yyvsp[-1].expr).unit, &(yyval.simple_expr).unit);
			break;
		case FUNCTION_ASIN:
			unit_asin_internal(&(yyvsp[-1].expr).unit, &(yyval.simple_expr).unit);
			break;
		case FUNCTION_TAN:
			unit_tan_internal(&(yyvsp[-1].expr).unit, &(yyval.simple_expr).unit);
			break;
	}
  }
...
yyerrlab:
  ...
  yytoken = yychar == YYUNITEMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
