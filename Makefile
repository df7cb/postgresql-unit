...
DATA_built = unit--2--3.sql unit--3.sql \
			 ...
			 unit--7--8.sql unit--8.sql
REGRESS = extension tables unit typmod binary unicode prefix units time temperature functions round derived compare aggregate iec custom
